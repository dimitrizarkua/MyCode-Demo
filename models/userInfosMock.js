export const userInfosMockData = {
  ...
  firstname: 'John',
  lastname: 'Doe',
  picture:  require('../img/coin-icn.png'), // or from an url: 'https://placeimg.com/120/120/people', // or from a relative path (NOTE: this path like public/.. may not be availaible when in dev hot reload!) './public/img/user.jpg',
  showPicture: true,
